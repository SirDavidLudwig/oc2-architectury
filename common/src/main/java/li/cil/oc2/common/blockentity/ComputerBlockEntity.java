...
public class ComputerBlockEntity extends ModBlockEntity implements TickableBlockEntity {
...
//    private final ComputerItemStackHandlers deviceItems = new ComputerItemStackHandlers();
    private FixedEnergyStorage energy = new FixedEnergyStorage(Config.computerEnergyStorage);
//    private final EnergyStorageComponent energy = EnergyStorageComponent.createFixed(Config.computerEnergyStorage);
...
//
    ...
    @Override
    public void collectComponents(final Consumer<IComponent> collector, @Nullable final Direction direction) {
...
//    @Override
//    protected void collectCapabilities(final ComponentCollector collector, @Nullable final Direction direction) {
